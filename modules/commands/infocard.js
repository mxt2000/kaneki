...
module.exports.run = async function ({ api, event, args, Users }) {
  ...
  if(event.type == "message_reply") { uid = event.messageReply.senderID }
    ...
    const res = await axios.get(`http://api.leanhtruong.net/api/info?api_key=LEANHTRUONG=jz2wy7POJ9wvARnYH0wvCWXYE73hVOlOLSXI1nsGyx3Vhf5vXW=APIKEY=PLANFREE&id=${uid}`); 
